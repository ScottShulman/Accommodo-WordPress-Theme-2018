...
function simpleMap(_latitude,_longitude, element, markerDrag){
    ...
    var marker = new MarkerWithLabel({
        ...
        map: map,
        icon: 'wp-content/themes/accommodo/assets/img/marker.png',
...
function bigMap(_latitude,_longitude, element, useAjax){
    if( document.getElementById(element) != null ){
        var urlToPHP;
        if( useAjax == true ){
            urlToPHP = "wp-content/themes/accommodo/assets/external/ajax.markers.php";
        }
        else {
        }
        ...
        function placeMarkers(locations){
            ...
            for (i = 0; i < locations.length; i++) {
                ...
                markerContent.innerHTML =
                    '<div class="map-marker">' +
                        '<div class="icon">' +
                            '<img src="wp-content/themes/accommodo/assets/img/marker.png">' +
                        '</div>' +
                    '</div>';
            ...
            var clusterStyles = [
                {
                    url: 'wp-content/themes/accommodo/assets/img/cluster.png',
                    height: 36,
                    width: 36
                }
            ];
        ...
        function ajaxLoadInfobox(i, marker, newMarkers, locations, _this, id){
            $.ajax({
                url: "wp-content/themes/accommodo/assets/external/ajax.infobox.php",
                dataType: "html",
                data: { id: id },
                method: "POST",
        ...
        function openInfobox(i, marker, newMarkers, locations, _this, htmlContent){
            ...
            infoboxOptions = {
                ...
                closeBoxURL: "wp-content/themes/accommodo/assets/img/close-btn.png",
