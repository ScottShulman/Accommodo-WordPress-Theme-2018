...
function bigMap(_latitude,_longitude, element){
    if( document.getElementById(element) != null ){
        ...
        google.maps.event.addListenerOnce(map, 'idle', function(){
            $.ajax({
                url: "assets/external/ajax.markers.php",
                dataType: "json",
                method: "POST",
...
function bigMap3(_latitude,_longitude, element){
    if( document.getElementById(element) != null ){
        //function loadMap(locations){
            //$.getScript("assets/external/locations.js", function(){
            //$.get("assets/external/locations.js", function() {
        var map = new google.maps.Map(document.getElementById(element), {
            zoom: 9,
            scrollwheel: true,
            center: new google.maps.LatLng(_latitude, _longitude),
        ...
        google.maps.event.addListenerOnce(map, 'idle', function(){
            $.ajax({
                ...
                success: function(data){
                    //console.log(data);
                    //bigMap2(_latitude,_longitude, element, locations);
                    placeMarkers(data);
                },
                error : function (msg) {
                    console.log("error");
