            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="main-content">
                        <div class="title">
                            <h1><?php if(isset($accommodo_redux_demo['blog_title'])){?>
                                    <?php echo esc_attr(htmlspecialchars_decode($accommodo_redux_demo['blog_title']));?>
                                    <?php }else{?>
                                    <?php echo esc_html__( 'Blog', 'accommodo' );
                                    }
                                    ?></h1>
                        </div>
                        <?php 
                        ...
                        <?php if ( has_post_thumbnail() ) { ?>
                            ...
                            <figure class="meta">
                                ...
                                <?php if ( is_sticky() )
                                 echo '<span class="featured-post">' . esc_html__( 'Sticky', 'accommodo' ) . '</span>';
                                 ?>
                            </figure>
