                ...
                <div class="col-md-9">
                    <div class="main-content">
                        <div class="title">
                            <h1><?php
                        if ( is_day() ) :
                            printf( esc_html__( 'Daily Archives: %s', 'accommodo' ), get_the_date() );

                        elseif ( is_month() ) :
                            printf( esc_html__( 'Monthly Archives: %s', 'accommodo' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'accommodo' ) ) );

                        elseif ( is_year() ) :
                            printf( esc_html__( 'Yearly Archives: %s', 'accommodo' ), get_the_date( _x( 'Y', 'yearly archives date format', 'accommodo' ) ) );

                        else :
                            esc_html_e( 'Archives', 'accommodo' );
